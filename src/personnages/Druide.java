...
public class Druide {
	...
	public void preparerPotion() {
		...
		if(forceDePotion > 7) parler("J'ai préparé unesuperpotiondeforce" + forceDePotion + ".");
		else parler("Je n'ai pas trouvé tous les ingrédients, ma potion est seulementdeforce" + forceDePotion + ".");
	}
